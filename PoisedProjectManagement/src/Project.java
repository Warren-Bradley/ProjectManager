 ...
 * Class 
 * <br>
 * This class keeps track of an individual projects stored in the company and all their needed details
 * and methods
 *
...
public class Project implements Serializable {
	 ...
	 * @param choice Integer reflecting index of which project the user chose to edit
		...
		while (true) {
			...
			if (option == 1) {
				...
				try {
					...
					FileWriter fi = new FileWriter(String.format("./src/Invoice for %s.txt",customer.getName()), true);
