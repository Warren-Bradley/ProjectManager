...
public class PoisedProjects implements OperationFunctions {
	...
	public static void main(String[] args) throws Exception {
		...
		Company poised = OperationFunctions.openProgram();
		...
		while (true) {
			...
			if (userChoice == 1) {
				...
				Person newPerson = OperationFunctions.newPerson(sc, "architect");
			...
			// If user chooses to create a new contractor
				...
				Person newPerson = OperationFunctions.newPerson(sc, "contractor");
			...
			// If user chooses to create a new project
				...
				OperationFunctions.newProject(poised, sc);
			}
		...
		OperationFunctions.saveProgram(poised);
	}
